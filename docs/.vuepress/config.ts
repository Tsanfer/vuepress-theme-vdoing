...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        ...
        items: [
          ...
          { text: '果实及种子类', link: '/note/seed/' },
          { text: '全草类', link: '/note/herb/' },
          { text: '动物类', link: '/note/animal/' },
          { text: '花类', link: '/note/flower/' },
          { text: '藤木类', link: '/note/vine/' },
          { text: '叶类', link: '/note/leaf/' },
          { text: '皮类', link: '/note/skin/' },
          { text: '矿物类', link: '/note/mineral/' },
          { text: '其他类', link: '/note/other/' },
          { text: '菌藻类', link: '/note/fungus/' },
          { text: '树脂类', link: '/note/resin/' },
        ],
      },
      {
        text: '性味',
    ...
    // bodyBgImg: [
    //   'https://www.jd-link.com/uploadfiles/2022/03/%E4%B8%AD%E8%8D%AF%E6%9D%90.jpg',
    // ], // body背景大图，默认无。 单张图片 String | 多张图片 Array, 多张图片时隔bodyBgImgInterval切换一张。
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/中医logo.png' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: '桂药本草云库',
